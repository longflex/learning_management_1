        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10"> <br> Sign in to your account.</div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Activate another and be paid</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">Activate another and be paid</div>
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        ...
                        <a href = "{{ route('register.index') }}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Register</a>
                    </div>
